...
CONFIG_NAME=metaworld_50_ppo_openpi_pi05_gse_joint_vlm_last4
SFT_MODEL="${SFT_MODEL:-/workspace/models/RLinf-Pi05-MetaWorld-SFT}"
RUN_DIR="${RUN_DIR:-/workspace/output/gse-joint-vlm-last4-seed42}"
EXP_NAME="${EXP_NAME:-gse_joint_vlm_last4_seed42}"
SEED="${SEED:-42}"
